export default function Step3CicloVida({ data, updateData, disabled }) {
    ...
    return (
        <div>
                ...
                {formData.descarte_documentado === 'sim' && (
                    <div className="form-group" style={{ marginTop: '1rem', animation: 'fadeIn 0.3s ease-in-out' }}>
                        ...
                        <select name="descarte_metodo" className="form-select" value={formData.descarte_metodo || ''} onChange={handleChange} disabled={disabled}>
                            <option value="">Selecione...</option>
                            <option value="wipe_seguro">Wipe seguro</option>
            ...
            <div className="step-section">
                <h3 className="step-section-title">Conformidade</h3>
                <div className="form-group">
                    <label className="form-label required">Conformidade com regulamentação local de privacidade de dados pessoais</label>
                    <div className="radio-group-horizontal">
                        <label className="form-check">
                            ...
                            <span className="form-check-label">Total</span>
                        </label>
                        <label className="form-check">
                        ...
                        <label className="form-check">
                            ...
                            <span className="form-check-label">Em implementação</span>
                        </label>
                    </div>
                </div>
            </div>
